...
const BookStoreCard = ({ id, title, subtitle, image, price, rating }) => {
  return (
    <div className="p-4 text-white shadow-md border ">
      ...
      <div className="mt-4">
        ...
        <p className="mt-2 text-base text-gray-100">{subtitle}</p>
        <p className="mt-2 text-gray-100">Price: ${price}</p>
        <p className="mt-2 text-gray-100">Rating: {rating}</p>
