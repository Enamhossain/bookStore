...
const DashboardLayout = () => {
  ...
  return (
    <div className="flex">
      <aside className="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-[#10d7fa11] border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
          <nav>
            <a className="flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200" href="#">
              ...
              <Link to="/dashboard/dashboard" className="mx-4 font-medium">Dashboard</Link>
            </a>
      ...
      <main className="flex-1 bg-[#006769]">
        <Outlet />
      </main>
    </div>
  );
